                ...
                <div class="card shadow-sm rounded"> 
                    <c:choose>
                        <c:when test="${not empty review.images}">
                                <img src="${review.images}" alt="리뷰 이미지" class="card-img-top" style="height: 200px; object-fit: cover;">
                        </c:when>
                        <c:otherwise>
                            <img src="default-image.jpg" alt="기본 이미지" class="card-img-top" style="height: 200px; object-fit: cover;"> 
                        </c:otherwise>
                    </c:choose>
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            평점: <span>${review.rating}</span><br>
                            내용: <%-- ${fn:length(review.content) > 100 ? fn:substring(review.content, 0, 100) + '...' : review.content} --%>
							${review.content}                             
                        </p>
                        ...
                        <div class="d-flex justify-content-end"> 
                            <a href="#" class="btn btn-primary" onclick="detail(${review.review_id})">자세히 보기</a>
                        </div>
                    </div>
                </div>
            </div>
